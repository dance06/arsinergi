...
//
//       $query =mysqli_query($conn,"UPDATE master_project_list SET project_name='".$project_name."', project_category_id='".$project_type."', project_pic='".$project_pic."', project_client_name='".$project_client_name."', project_measurement_total='".$project_measurement_total."', project_rb_total='".$project_rb_total."', project_rab_total='".$project_rab_total."' WHERE project_id =4");
//
//
//       if($query){
...
//       }
      ...
      $sql =mysqli_query($conn,"INSERT INTO master_project_list(project_name, project_category_id, project_pic, project_client_name, project_measurement_total, project_rb_total, project_rab_total)
                VALUES ('$project_name', '$project_type', '$project_pic', '$project_client_name', '$project_measurement_total','$project_rab_total', '$project_rb_total')");
