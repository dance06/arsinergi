...
<table id="tableRB" class='table table-stripped' style="width:95%; overflow-y: visible; float:left;">
	...
	<thead>
		<tr>
			<th>Tahun</th>
			<th>Periode</th>
			<th style="width:50%">Tgl.order</th>
			<th>Gol</th>
			<th>Item</th>
			<th>Tipe</th>
			<th>Jml.order</th>
...
?>
			...
			<td>
				<div class="form-group" >
					<div class="input-group">
						<input type="text" class="form-control date-order" name="rb_order_date[]" style="width:200px; position:static;" data-date-format="YYYY/MM/DD"/>
					</div>
				</div>
			</td>
			<td>
			...
			<td>
				<div class="form-group"  >
					<div class="ui-widget input">
						<input type="text" class="form-control order-item" id="rb-item" name="rb_item[]" style="width:200px"/>
					</div>
				</div>
			</td>
			<td>
			...
			<td>
				<div class="form-group"  >
					<div class="input-group">
						<input type="number" class="form-control" name="rb_order_total[]" id="rb_order_total" style="width:80px" min="0" onfocus="startCalculate()" onblur="stopCalc()"/>
					</div>
				</div>
			</td>
			<td>
				<div class="form-group"  >
					<div class="input-group">
						<input type="number" class="form-control" name="rb_order_sent[]" id="rb_order_sent" style="width:80px" min="0"min="0"/>
					</div>
				</div>
			</td>
			<td>
				<div class="form-group" >
					<div class="input-group">
						<input type="number" class="form-control" name="rb_volume_paid[]" id="rb_volume_paid" style="width:80px" min="0"/>
					</div>
				</div>
			</td>
			<td>
...
<!-- <input type="text" name="price_total" id="price_total" style="width:120px" onfocus="startCalculate()" onblur="stopCalc()"/> -->
			...
			<td>
				<div class="form-group"  >
					<div class="input-group">
						<input type="text" class="form-control date1-paid" name="rb_order_date_paid[]" style="width:150px"  data-date-format="YYYY/MM/DD"/>
					</div>
				</div>
			</td>
			<td>
...
<table id="gridRealBahan" class="table table-striped table-hover">
	<thead>
		<tr>
			<th style="text-align:center;"></th>
			<th style="text-align:center;">Tahun</th>
      <th style="text-align:center;">Periode</th>
      <th style="text-align:center; width:auto;">Tgl.order</th>
	...
	while($data=mysqli_fetch_array($result)){
		...
		echo "<td><a href='../tables/editrb.php?id=".$data['rb_id']."&rb_project_id=".$data['rb_project_id']."' class='btn btn-default btn-s' value='edit'>
				<span class='glyphicon glyphicon-edit' id='editproject' aria-hidden='true'></span>
						...
						</a>&nbsp;<button id='btn_save' name='tsave2' type='Submit' class='btn btn-default btn-s link-save'>
								<span class='glyphicon glyphicon-ok' aria-hidden='true'></span></button></td>";
								// <a href='#' class='btn btn-default btn-s link-edit' value='edit'>
								// 		<span class='glyphicon glyphicon-edit' id='editproject' aria-hidden='true'></span>
		...
		echo "<td><span class='project-label1 project-label1'>".$data['rb_year']."</span><ixnput type='text' name='rb_year1' class='project-input1 project-input' style='display:none' /></td>";
    echo "<td><span class='project-label1 project-label2'>".$data['rb_periode']."</span><input type='text' name='rb_periode1' class='project-input2 project-input' style='display:none' /></td>";
		...
		echo "<td><span class='project-label1 project-label5'>".$data['rb_item']."</span><input type='text' name='rb_item1' class='project-input5 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label6'>".$data['rb_item_detail']."</span><input type='text' name='rb_item detail1' class='project-input6 project-input' style='display:none' /></td>";
    echo "<td><span class='project-label1 project-label7'>".number_format($data['rb_order_total'],2,".",",")."</span><input type='text' name='rb_order_total1' class='project-input7 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label8'>".number_format($data['rb_order_sent'],2,".",",")."</span><input type='text' name='rb_order_sent1' class='project-input8 project-input' style='display:none' /></td>";
    echo "<td><span class='project-label1 project-label9'>".number_format($data['rb_volume_paid'],2,".",",")."</span><input type='text' name='rb_volume_paid1' class='project-input9 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label10'>".number_format($data['rb_volume_indent'],2,".",",")."</span><input type='text' name='rb_volume_indent1' class='project-input10 project-input' style='display:none' /></td>";
    ...
    echo "<td><span class='project-label1 project-label12'>".convertToRp($data['rb_item_price'])."</span><input type='text' name='rb_item_price1' class='project-input12 project-input' style='display:none' /></td>";
    echo "<td class='row-price-total'><span class='project-label1 project-label13'>".convertToRp($data['rb_item_price_total'])."</span><input type='text' name='rb_item_price_total1' class='project-input13 project-input' style='display:none' /></td>";
		echo "<td class='row-price-indent'><span class='project-label1 project-label14'>".convertToRp($data['rb_price_indent'])."</span><input type='text' name='rb_price_indent1' class='project-input14 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label15'>".$data['supplier_name']."</span><input type='text' name='supplier_name1' class='project-input15 project-input' style='display:none' /></td>";
    echo "<td><span class='project-label1 project-label16'>".$data['rb_no_ac']."</span><input type='text' name='rb_no_ac1' class='project-input16 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label17'>".$data['payment_status']."</span><input type='text' name='payment_status1' class='project-input17 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label18'>".$data['rb_no_faktur']."</span><input type='text' name='rb_no_faktur' class='project-input18 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label19'>".$data['rb_no_paid']."</span><input type='text' name='rb_no_paid1' class='project-input19 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label20'>".convertToDateID($data['rb_order_date_paid'])."</span><input type='text' name='rb_order_date_paid1' class='project-input20 project-input' style='display:none' /></td>";
		echo "<td><span class='project-label1 project-label21'>".$data['rb_notes']."</span><input type='text' name='rb_notes1' class='project-input21 project-input' style='display:none' /></td>";
		echo "</tr>";
		$tempPriceTotal+=$data['rb_item_price_total'];
		$tempPriceTotalIndent+=$data['rb_price_indent'];
	}
	?>
	</tbody>
<tfoot>
	<tr>
		<th colspan="6" style="text-align:right; width:auto;">Grand Total</th>
		<th></th>
		<th></th>
		<th></th>
		<th></th>
		...
		<th></th>
		<th></th>
		<th><?php echo convertToRp1($tempPriceTotal); ?></th>
		<th><?php echo convertToRp1($tempPriceTotalIndent); ?></th>
	</tr>
</tfoot>
</table>
...
$(document).ready(function(){
		$("#rb_volume_paid").val(0);
		$("#rb_order_sent").val(0);
		$("#rb_order_total").val(0);
    // var container= $('#tableRB').html(); // container to add
    var ids=1; //id numbers for add. datepickers
		$('.date-order').datetimepicker();
		$('.date1-paid').datetimepicker();
    $('#btn_plus').click(function() {
				var table = $('#tableRB').find('tbody');
				var firstRow = '<tr>' + table.find('tr:first').html() + '</tr>';
				var newRow = $(firstRow);
				table.append(newRow);
				var newID = "date-" + ids;
				var newID1 = "date1-" + ids;
				var newIDitem = "item-" + ids;
				// clone.find('input').val('tes');
        newRow.find('.date-order').attr('id',  newID);// each datepicker must have a unique id.
				newRow.find('.date1-paid').attr('id',  newID1);// each datepicker must have a unique id.
        newRow.find('.order-item').attr('id',  newIDitem);// each datepicker must have a unique id.
				$("#" + newID).datetimepicker();
					$("#" + newID1).datetimepicker();
					$("#" + newIDitem).autocomplete({
						  source: DaftarItem
					});
        // $("#date-2").datepicker();
...
$(document).on('focus',".date1-paid", function(){ //bind to all instances of class "date".
    // $(this).datetimepicker();
});
$(function() {
    // var DaftarItem = [<?php echo ambil_item();?>];
...
// });
//
// $(document).on('focus',".date-order", function(){
//     //$(this).datepicker();
// });​
...
// 	});
// 	// alert(grandTotal);
// 	//$("#grandTotal").html(<?php echo convertToRp(15000);  ?>);
...
$(document).on('click', '.link-save', function(){
	...
	var id = row.data('id');
	var rb_order_sent1 = row.find('[name="rb_order_sent1"]').val();
	var rb_volume_paid1 = row.find('[name="rb_volume_paid1"]').val();
	var rb_volume_indent1 = row.find('[name="rb_volume_indent1"]').val();
	var rb_item_price1 = row.find('[name="rb_item_price1"]').val();
	var rb_item_price_total1 = row.find('[name="rb_item_price_total1"]').val();
	var rb_price_indent1 = row.find('[name="rb_price_indent1"]').val();
	var payment_status1 = row.find('[name="payment_status1"]').val();
	//alert(id);
	$.post('insertmp2.php', {
		project_id : id,
		rb_order_sent1: rb_order_sent1,
		rb_volume_paid1: rb_volume_paid1,
		rb_volume_indent1: rb_volume_indent1,
		rb_item_price1: rb_item_price1,
		rb_item_price_total1: rb_item_price_total1,
		rb_price_indent1: rb_price_indent1,
		payment_status1: payment_status1
	}, function(val){
		//alert(val);
